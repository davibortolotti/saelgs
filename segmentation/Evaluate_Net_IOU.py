...
Image_Dir="../test_images/"#Images for evaluation
Label_Dir="../test_masks/"#Ground truth  per pixel annotation for the images in Image dir
Trained_model_path="TrainedModelWeights/42000_0707.torch"# "Path to trained net weights

NUM_CLASSES = 2 #Number of classes the net predicts
