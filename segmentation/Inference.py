...
Trained_model_path="TrainedModelWeights/2000.torch"# "Path to trained net weights

w=0.9# weight of overlay on image for display
Output_Dir="Output_Prediction/test_2000/" #Folder where the output prediction will be save
